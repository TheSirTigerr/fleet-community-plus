...
import (
	...
	"github.com/fleetdm/fleet/v4/server/communityplus/hostidentity/types"
)
...
type OrbitConfigNotifications struct {
	...
	PendingCommunityPlusDeploymentIDs []string `json:"pending_communityplus_deployment_ids,omitempty"`
